...
from ret_clip.RET_CLIP.clip.model import convert_state_dict
from ret_clip.RET_CLIP.training.eval_RFMiD import eval_multiLabelCls_ViT, eval_multiLabelCls_RN50
