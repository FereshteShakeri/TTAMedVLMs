...
from ret_clip.RET_CLIP.clip import load
from ret_clip.RET_CLIP.clip.model import convert_weights, convert_state_dict, resize_pos_embed, CLIP
from ret_clip.RET_CLIP.training.train import train, evaluate
from ret_clip.RET_CLIP.training.data import get_data
from ret_clip.RET_CLIP.training.params import parse_args
from ret_clip.RET_CLIP.training.logger import setup_primary_logging, setup_worker_logging
from ret_clip.RET_CLIP.training.scheduler import cosine_lr
    ...
    if args.resume is None:
        ...
        if args.resume_visual is not None:
            if os.path.isfile(args.resume_visual):
                ...
                # # 2023.11.1 support for PMC-CLIP
                # sd_vision = {k: v for k, v in vision_encoder["state_dict"].items() if
