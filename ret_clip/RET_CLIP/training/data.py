...
class LMDBDataset(Dataset):
    ...
    def __getitem__(self, index):  # 通过index来getitem
        ...
        img_l = Image.open(BytesIO(base64.urlsafe_b64decode(img_b64_l)))
        img_r = Image.open(BytesIO(base64.urlsafe_b64decode(img_b64_r)))
        ...
        return img_l, img_r, text, eos_index
