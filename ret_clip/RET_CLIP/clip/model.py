...
from ret_clip.RET_CLIP.clip import _tokenizer
from ret_clip.RET_CLIP.clip.configuration_bert import BertConfig
from ret_clip.RET_CLIP.clip.modeling_bert import BertModel
...
class CLIP(nn.Module):
    ...
    def encode_image(self, img_l, img_r=None, mask_ratio=0):
        if img_r is None:
            if isinstance(self.visual, ModifiedResNet):
